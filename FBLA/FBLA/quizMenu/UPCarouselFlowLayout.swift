...
//READ: This code was taken from an open source github page, all of the code from this class was developed by the copyright author, we simply used it to develop a menu :)
